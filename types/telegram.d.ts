...
export type FullscreenFailedCallback = (eventData: {error: 'UNSUPPORTED' | 'ALREADY_FULLSCREEN'}) => void;
export type HomeScreenAddedCallback = () => void;
export type HomeScreenCheckedCallback = (eventData: {status: 'unsupported' | 'unknown' | 'added' | 'missed'}) => void;
...
export type EmojiStatusAccessRequestedCallback = (eventData: {status: 'allowed' | 'cancelled'}) => void;
export type FileDownloadRequestedCallback = (eventData: {status: 'downloading' | 'cancelled'}) => void;
